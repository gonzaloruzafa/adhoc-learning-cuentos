...
export const InputSection: React.FC<InputSectionProps> = ({ onSubmit, isLoading, loadingProgress = 0 }) => {
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="pt-4">
          ...
          {isLoading && loadingProgress > 0 && (
            <div className="mt-4 w-full bg-gray-200 rounded-full h-2.5 overflow-hidden shadow-inner">
              <div 
